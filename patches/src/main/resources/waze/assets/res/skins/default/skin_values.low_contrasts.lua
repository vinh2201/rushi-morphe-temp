...
local Palette = {
	...
	map_background = rgb(0xebe7dd),
	map_missing = rgb(0xebe7dd),

	labels = rgb(0x3B3838),
	labels_strong = rgb(0x3b3838),
	...
	freeways = rgb(0xffc44d),
	primary = rgb(0xffc44d),
	secondary = rgb(0xffe266),
	highways = rgb(0xffe266),
	street = rgb(0xffffff),
	private = rgb(0xffffff),
	trails4x4 = rgb(0xd0ccc4),
   alleys = rgb(0xffffff),
	...
	ferry_stroke = rgb(0x9fd3da),

	pedestrian = rgb(0xd0ccc4),
	trails = rgb(0xd0ccc4),
	walkway = rgb(0xd0ccc4),

	-- Areas ------------------------

	cities = rgb(0xFF0000),
	stations = rgb(0xd4d0cc),
	parks = rgb(0xa9c567),
	sea = rgb(0x80aaff),
	lakes = rgb(0x80aaff),
	rivers = rgb(0x80aaff),
	...
	label_cities = rgb(0x000000),
	label_vegetation = rgb(0x46751a),
	label_water = rgb(0x6383A0),

	-- Others --------------------------

	navigation = rgb(0x7252FE),
	stop_point = rgb(0x7252FE),
	shared = rgb(0x7252FE),
	shared_stop = rgb(0x7252FE),
   snail = rgb(0xCECECE),
  ...
  detour_stroke = rgb(0x25CE09),
	...
	alt_color_current = rgb(0x7252FE),
  ...
  traffic_route_standstill = rgb(0xE12D2D),
