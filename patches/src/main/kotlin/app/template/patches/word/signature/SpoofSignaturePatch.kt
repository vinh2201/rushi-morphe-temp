package app.template.patches.word.signature
...
private const val WORD_CERT_V3 =
...
private const val WORD_CERT_LEGACY =
...
private val wordCertSeedPatch = rawResourcePatch(default = false) {
    execute {
        seedCert(WORD_CERT_V3)
        seedCert(WORD_CERT_LEGACY)
    }
}

private val wordSpoofSignaturePatch = bytecodePatch(
) {
    dependsOn(wordCertSeedPatch, spoofSignatureVerificationPatch)
}

@JvmSynthetic
internal fun wordSpoofSignatureDependency() = wordSpoofSignaturePatch
